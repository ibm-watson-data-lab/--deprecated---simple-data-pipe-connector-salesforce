...
function sfConnector( parentDirPath ){
	...
	this.fetchRecords = function( table, pushRecordFn, done, pipeRunStep, pipeRunStats, logger, pipe, pipeRunner ){
		...
		.on("error", function(err) {
			// err properties:
			//          "message", e.g. "Implementation restriction: CollaborationGroupRecord requires a filter by a single Id, CollaborationGroupId or RecordId using the equals operator",
            //          "stack", e.g. "MALFORMED_QUERY: Implementation restriction: CollaborationGroupRecord requires a filter by a single Id, CollaborationGroupId or RecordId using the equals operator\n    at HttpApi.getError (/home/vcap/app/node_modules/simple-data-pipe-connector-salesforce/node_modules/jsforce/lib/http-api.js:238:13)\n    at /home/vcap/app/node_modules/simple-data-pipe-connector-salesforce/node_modules/jsforce/lib/http-api.js:83:22\n    at _fulfilled (/home/vcap/app/node_modules/simple-data-pipe-connector-salesforce/node_modules/jsforce/node_modules/q/q.js:834:54)\n    at self.promiseDispatch.done (/home/vcap/app/node_modules/simple-data-pipe-connector-salesforce/node_modules/jsforce/node_modules/q/q.js:863:30)\n    at Promise.promise.promiseDispatch (/home/vcap/app/node_modules/simple-data-pipe-connector-salesforce/node_modules/jsforce/node_modules/q/q.js:796:13)\n    at /home/vcap/app/node_modules/simple-data-pipe-connector-salesforce/node_modules/jsforce/node_modules/q/q.js:604:44\n    at runSingle (/home/vcap/app/node_modules/simple-data-pipe-connector-salesforce/node_modules/jsforce/node_modules/q/q.js:137:13)\n    at flush (/home/vcap/app/node_modules/simple-data-pipe-connector-salesforce/node_modules/jsforce/node_modules/q/q.js:125:13)\n    at doNTCallback0 (node.js:419:9)\n    at process._tickCallback (node.js:348:13)"
            //          "name", e.g. "MALFORMED_QUERY",
            //          "errorCode", e.g. "MALFORMED_QUERY"
			logger.error("Error while processing table " + table.name + ":");
			logger.error(" Message: " + err.message);
			logger.error(" Stack: " + err.stack);
			logger.error(" Name: " + err.name);
			logger.error(" ErrorCode: " + err.errorCode);

			return done({errorStatus: err.message});
		})
